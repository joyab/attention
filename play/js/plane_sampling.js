...
var points = vis.selectAll(".point")
  ...
  .enter().append("svg:circle")
    ...
    .attr("fill", "steelblue")
    .attr("cx", function(d, i) { return xRange(d * 1); } )
    .attr("cy", function(d, i) { 
      return findYatXbyBisection(xRange(d * 1), path.node(), 0.1);})
...
var sticks = vis.selectAll(".sticks")
  .data(d3.range(num_samples))
  .enter().append("line")
    .attr("x1", function(d, i) { return xRange(d * 1); })
    .attr("y1", yRange(0))
    //.attr("y1", function(d, i) { return findYatXbyBisection(xRange(d * 10), path.node(), 0.1);} )
    .attr("x2", function(d, i) { return xRange(d * 1); })
